...
from src.document_analyzer.data_analysis import DocumentAnalyzer        # Your PDFHandler class
from src.document_ingestion.data_ingestion import DocumentHandler  # Your DocumentAnalyzer class
...
def main():
    try:
        ...
        analysis_result = analyzer.analyze_document(text_content[:5500])
